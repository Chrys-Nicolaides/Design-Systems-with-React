...
export const darkTheme = {
  ...
  status: {
    ...
    warningColorActiveBorder: yellow[800],
    warningColorActive: yellow[200],
    warningDarkText: yellow[800],
    warningSecondary: yellow[200],
    errorColor: red[400],
